...
public class FullTermTable {
	...
	public static final Map<Integer,Year> table = Collections.unmodifiableMap(init());
	...
	public static class Year {
		...
		public Year(int startingYear, int michStartDay, int michEndDay,
			...
			DateTime michStart = new DateTime(startingYear, 10, michStartDay, 0,
					0);
			...
			DateTime lentStart = new DateTime(startingYear + 1, 1,
					lentStartDay, 0, 0);
			DateTime lentEnd = new DateTime(startingYear + 1, 3, lentEndDay,
					23, 59);
